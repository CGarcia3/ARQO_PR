...
# Elaboracion:
vsim -gINIT_FILENAME_INST="inst_programa_test.txt" -gINIT_FILENAME_DATA="datos_programa_test.txt" -gN_CYCLES=150 processorRV_tb
# vsim -gINIT_FILENAME_INST="test_0_ins.txt" -gINIT_FILENAME_DATA="test_0_dat.txt" -gN_CYCLES=150 processorRV_tb
