...
add wave -noupdate /processorrv_tb/i_processor/forward_A
add wave -noupdate /processorrv_tb/i_processor/forward_B
add wave -noupdate /processorrv_tb/i_processor/forward_A_mux
add wave -noupdate /processorrv_tb/i_processor/forward_B_mux
add wave -noupdate -divider -height 25 {New Divider}
add wave -noupdate /processorrv_tb/i_processor/reg_RD_data
add wave -noupdate /processorrv_tb/i_processor/reg_a3_WB
add wave -noupdate /processorrv_tb/i_processor/alu_res_EX
add wave -noupdate -divider -height 25 {New Divider}
